...
-- Dumping data for table db_kargo_2.districts: ~514 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `trucks` (
  ...
  PRIMARY KEY (`id`),
  KEY `trucks_type_id` (`truck_type_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table db_kargo_2.trucks: ~0 rows (approximately)
/*!40000 ALTER TABLE `trucks` DISABLE KEYS */;
INSERT IGNORE INTO `trucks` (`id`, `license_number`, `truck_type_id`, `plate_type`, `production_year`, `status`, `stnk`, `kir`) VALUES
	(1, 'B 1234 ABC', 1, 'Black', 2021, 1, NULL, NULL),
	(2, 'B 1235 ABC', 2, 'Yellow', 2021, 1, NULL, NULL),
	(3, 'B 1236 ABC', 4, 'Black', 2021, 1, NULL, NULL),
	(4, 'B 1237 ABC', 1, 'Yellow', 2021, 1, NULL, NULL);
...
INSERT IGNORE INTO `truck_types` (`id`, `name`) VALUES
	(1, 'Pick Up'),
